...
import static com.openbravo.pos.payment.JPaymentPlanSepare.valorTxtDinero;
...
public abstract class JPaymentSelect extends javax.swing.JDialog
    ...
    private static boolean ABRIR_CAJON;
    ...
    public static double totalPlanSepare;
    public static String nombrePagoCliente;

    
    public JPaymentSelect() {
    }
    ...
    public boolean showDialog(double total, CustomerInfoExt customerext, double deposit) {
        ...
        ABRIR_CAJON = m_jButtonPrint.isSelected();
...
// Get the size of the screen, and center the dialog in the window
    ...
    public class JPaymentDaviPlataCreator implements JPaymentCreator {
        ...
        @Override
        public String getIconKey() {
            return "/com/openbravo/images/daviplata.png";
        }
    }
    ...
    public class JPaymentDebtCreator implements JPaymentCreator {
        ...
        public class JPaymentPlanSepareCreator implements JPaymentCreator {

        @Override
        public JPaymentInterface createJPayment() {
            return new JPaymentPlanSepare(JPaymentSelect.this);
        }

        @Override
        public String getKey() {
            return "payment.debt1";
        }
        ...
        @Override
        public String getIconKey() {
            return "/com/openbravo/images/planSepare.png";
        }
    }
    ...
    public class JPaymentNequiCreator implements JPaymentCreator {
        ...
        @Override
        public String getIconKey() {
            return "/com/openbravo/images/nequi.png";
        }
    }
    ...
    private void initComponents() {
        ...
        m_jLblTotalEuros1.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jTabPayment.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jlblPrinterStatus.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void m_jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jButtonOKActionPerformed
            ...
            SwingWorker worker = new SwingWorker() {
                ...
                @Override
                public void done() {
                    if ("debt1".equals(returnPayment.getName())) {
                        if (customerext != null) {
                            PlanSepareModelo planSepareModelo = new PlanSepareModelo();
                            String taxCustomerID = customerext.getId();

                            if (!planSepareModelo.verificarRegistroExistente(taxCustomerID)) {
                                AlertasPersonalizadas.mostrarAlertaInformacion(
                                        "El cliente: " + customerext.getName() + " ya tiene un plan Separe. " +
                                                "Cancele el plan que tiene para poder realizar otro"
                                );
                                return;
                            }
                            double precioTotal = returnPayment.getTotal();
                            int precioTotalSinDecimales = (int) Math.round(precioTotal);
                            if(valorTxtDinero.isEmpty() || (valorTxtDinero.length() == 1 && valorTxtDinero.equals("$"))){
                                AlertasPersonalizadas.mostrarAlertaInformacion(
                                        "el campo no puede estar vacio o contener solo el signo pesos"
                                );
                                return;
                            }
                            JPaymentPlanSepare p = new JPaymentPlanSepare();

                            totalPlanSepare = Double.parseDouble(quitarFormatoMoneda(valorTxtDinero));
                            int totalPlanSepareInt = (int) Math.floor(totalPlanSepare);
                            if (totalPlanSepareInt >= precioTotalSinDecimales ) {
                                AlertasPersonalizadas.mostrarAlertaInformacion("Si va a pagar toda la factura por favor elija otra opción");
                                return;
                            }
                        }
                    }

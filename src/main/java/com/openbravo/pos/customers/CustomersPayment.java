...
import com.openbravo.pos.planSepare.PlanSepares;
...
import com.openbravo.pos.planSepare.InformePlanSepare;
...
//        btnPay.setEnabled(customer.getCurdebt() != null && customer.getCurdebt().doubleValue() > 0.0);
    ...
    private void resetCustomer() {
        ...
        btnPlanSepare.setEnabled(false);
...
// JG 6 May use multicatch
    ...
    private void initComponents() {
        ...
        btnPlanSepare = new javax.swing.JButton();
        btnInformePlanSepare = new javax.swing.JButton();
        ...
        btnPlanSepare.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/plansepare.png"))); // NOI18N
        btnPlanSepare.setText("Plan Separe");
        btnPlanSepare.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPlanSepareActionPerformed(evt);
            }
        });
        jPanel6.add(btnPlanSepare);

        btnInformePlanSepare.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/informePlanSepare.png"))); // NOI18N
        btnInformePlanSepare.setText("InformePlanSepare");
        btnInformePlanSepare.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnInformePlanSepareActionPerformed(evt);
            }
        });
        jPanel6.add(btnInformePlanSepare);
        ...
        txtCard.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtCurdebt.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtMaxdebt.setBackground(new java.awt.Color(255, 255, 255));
        ...
        txtTaxId.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btnInformePlanSepareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInformePlanSepareActionPerformed
          InformePlanSepare informePlanSepare = new InformePlanSepare();
          informePlanSepare.setVisible(true);
    }//GEN-LAST:event_btnInformePlanSepareActionPerformed

    private void btnPlanSepareActionPerformed(java.awt.event.ActionEvent evt) {
        PlanSepareModelo planSepareModelo = new PlanSepareModelo();

        if(planSepareModelo.listarProducto(idCliente).isEmpty()){
            AlertasPersonalizadas.mostrarAlertaInformacion("Este usuario no tiene un plan separado");
            return;
        }
        PlanSepares planSepare = new PlanSepares();
        planSepare.setVisible(true);
   
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnCustomer;
    private javax.swing.JButton btnInformePlanSepare;
    private javax.swing.JButton btnPay;
    private javax.swing.JButton btnPlanSepare;

...
public void resetTranxTable() {
    ...
    public Object createValue() throws BasicException {
        ...
        if (m_jName.getText().contains("&")) {
            AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.ampersand"));
        }        
...
// JG 10 April 2016 - Revision    
    ...
    private void initComponents() {
        ...
        m_jVisible.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jLblTranCount.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jVip.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void jBtnCreateCardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCreateCardActionPerformed
       boolean confirmacion = AlertasPersonalizadas.mostrarAlertaConfirmacion(LocalRes.getIntString("message.cardnew"));
        if (confirmacion) {            
    ...
    private void jBtnClearCardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnClearCardActionPerformed
        boolean confirmacion = AlertasPersonalizadas.mostrarAlertaConfirmacion(LocalRes.getIntString("message.cardremove"));
        if (confirmacion) {
            jcard.setText(null);
            m_Dirty.setDirty(true);
        }
    ...
    private void webBtnMailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_webBtnMailActionPerformed
        ...
        if(!"".equals(txtEmail.getText())) {
            ...
            if (Desktop.isDesktopSupported() 
                ...
                AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.email")+
                        " Email");
            }        
        }
    ...
    private void jBtnShowTransActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnShowTransActionPerformed
        ...
        if (cId != null) {
            ...
            if (transactionModel.getRowCount()> 0){
                ...
                jTableCustomerTransactions.setVisible(false);
                AlertasPersonalizadas.mostrarAlertaInformacion("No Transactions for this Customer"+
                        " Transactions");
            }
            resetTranxTable();
        }
...
//        jLblDiscount.setVisible(selected);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.uuidcopy"));        
        }

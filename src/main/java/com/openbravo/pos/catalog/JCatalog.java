...
public class JCatalog extends JPanel implements ListSelectionListener, CatalogSelector {
    ...
    public JCatalog(DataLogicSales dlSales, boolean pricevisible, 
        ...
        m_jscrollcat.getVerticalScrollBar().setPreferredSize(new Dimension(20, 20));
         JScrollBar verticalScrollBar = m_jscrollcat.getVerticalScrollBar();
...
// this is the new panel that displays when a sub catergory is selected mouse does not work here        
    ...
    private void initComponents() {
        ...
        m_jCategories.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jRootCategories.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jscrollcat.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jSubCategories.setBackground(new java.awt.Color(255, 255, 255));

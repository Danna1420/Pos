...
public class JSupplierFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private void init(DataLogicSuppliers dlSuppliers) {
        ...
        jScrollPane1.getVerticalScrollBar().setPreferredSize(new Dimension(20, 20));
...
//        m_jKeys.setSupplierFinder(this);
    ...
    private void initComponents() {
        ...
        m_jKeys.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jImageViewerSupplier.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jtxtTaxID.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jtxtSearchKey.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jtxtPostal.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jtxtName.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jtxtPhone.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jtxtName2.setBackground(new java.awt.Color(255, 255, 255));

...
public abstract class JPanelTicket extends JPanel implements JPanelView, BeanFactoryApp, TicketsEditor {
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        String usuario = String.valueOf(m_App.getAppUserView().getUser().getUserInfo().getName());
        int permiso = m_App.getAppUserView().getUser().m_apermissions.size();
       //usuario.equals("Administrator")

        
        /*if(permiso == 151){
            btnAbrirCajon.setVisible(true);
        }else{
            btnAbrirCajon.setVisible(false);
        }*/
        ...
        m_ticketlines.setBackground(Color.WHITE);
        ...
        if (this instanceof JPanelTicketSales) {
            ...
            if (AppConfig.getInstance().getProperty("machine.saleslayout") != null) {
                ...
                if (AppConfig.getInstance().getProperty("machine.saleslayout").equals("Layout1")) {
                    ...
                    ((JPanel) southpanel.getComponent(0))
    ...
    private void printPartialTotals() {
        ...
        if (m_oTicket.getLinesCount() == 0) {
            ...
            labelPrecio.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
            labelPrecio.setText(m_oTicket.printTotal());
        }
        repaint();
    }

    public static String formatoMoneda(double amount) {
        NumberFormat currencyFormat = NumberFormat.getCurrencyInstance(new Locale("es", "CO"));
        currencyFormat.setMinimumFractionDigits(2); // Asegura que se muestren dos decimales
        currencyFormat.setMaximumFractionDigits(2);
        String formattedAmount = currencyFormat.format(amount);

        // Eliminar los dos últimos decimales
    ...
    public static String quitarFormatoMoneda(String text) {
        // Remueve todo lo que no sea dígito o coma
        String soloNumeros = text.replaceAll("[^\\d,]", "");
        int indiceComa = soloNumeros.indexOf(",");
        if (indiceComa != -1) {
            soloNumeros = soloNumeros.substring(0, indiceComa);
        }
                    ...
                    try {
                        ...
                        if (oProduct == null) { // nothing returned so display message to user
                            ...
                            TaxInfo tax = taxeslogic // get the TaxRate for the product
                                    .getTaxInfo(oProduct.getTaxCategoryID(), m_oTicket.getCustomer()); // calculate if
                                                                                                       // ticket has a
                            // Customer
                                ...
                                case "02": // now we need to calculate some values
                                    ...
                                    dUnits = (Double.parseDouble(sVariableNum)
                                            / 100) / oProduct.getPriceSellTax(tax); // Units as proportion of selling
                                                                                    // price
                                    oProduct.setProperty("product.price", Double.toString(oProduct.getPriceSell())); // push
                                                                                                                     // to
                                                                                                                     // screen
                                    break;
                                case "20": // as above
                        ...
                        if (autoLogoff != null) {
                            if (autoLogoff.equals("true")) {
                                if ("restaurant".equals(
                                        ...
                                        && ("true".equals(
                                                m_App.getProperties().getProperty("till.autoLogoffrestaurant")))) {
                                    deactivate();
                                    setActiveTicket(null, null);
                                } else {
                                    ((JRootApp) m_App).closeAppView();
        ...
        if (m_App.getAppUserView().getUser().hasPermission("sales.Total")) {
            ...
            try {
                ...
                if (executeEvent(ticket, ticketext, "ticket.total") == null) {
                    ...
                    printTicket("Printer.TicketTotal", ticket, ticketext, false);
                    ...
                    if (paymentdialog.showDialog(ticket.getTotal(), ticket.getCustomer())) {
                        ...
                        if (executeEvent(ticket, ticketext, "ticket.save") == null) {
                            ...
                            printTicket(paymentdialog.isPrintSelected() || warrantyPrint
                                    ? "Printer.Ticket"
                                    : "Printer.Ticket2", ticket, ticketext, true);
    ...
    private void printTicket(String sresourcename, TicketInfo ticket, Object ticketext, Boolean imprimir) {
        ...
        if (sresource == null) {
            ...
            try {
                boolean cajonAbierto = JPaymentSelect.abrirCajon();
                if (cajonAbierto) {
    ...
    public static void abrirCajonDinero() {
        PrintService[] serviciosImpresion = PrintServiceLookup.lookupPrintServices(null, null);

        if (serviciosImpresion.length == 0) {
            System.out.println("No se encontraron impresoras configuradas.");
            return;
        }

        PrintService servicioImpresion = serviciosImpresion[0];
        DocPrintJob trabajoImpresion = servicioImpresion.createPrintJob();
        DocFlavor formato = DocFlavor.BYTE_ARRAY.AUTOSENSE;
        Doc documento = new SimpleDoc(new byte[] { 27, 112, 0, 25, (byte) 250 }, formato, null);
        PrintRequestAttributeSet atributosSolicitudImpresion = new HashPrintRequestAttributeSet();

        try {
            trabajoImpresion.print(documento, atributosSolicitudImpresion);
            System.out.println("Cajón del dinero abierto.");
        } catch (PrintException ex) {
            System.out.println("Error al abrir el cajón: " + ex.getMessage());
        }
    ...
    private Object evalScript(ScriptObject scr, String resource, ScriptArg... args) {
        ...
        try {
            ...
            // msg.show(this);
            double valorDevolver = scr.ticket.getPayments().get(0).getPaid();
            double valorRecibido = scr.ticket.getPayments().get(0).getTotal();
            mostrarCambio(valorRecibido, valorDevolver);

            return msg;
        }
    }

    public void mostrarCambio(double valorRecibido, double valorDevolver) {
        double resultado = valorDevolver - valorRecibido;

        if (resultado != 0 && resultado > 0) {
            String resultadoFinal = Formats.CURRENCY.formatValue(resultado);
            Font font = new Font("Arial", Font.PLAIN, 30);

            JLabel mensaje = new JLabel(resultadoFinal);
    ...
    public class ScriptObject {
        ...
        public Object evalScript(String code, ScriptArg... args) throws ScriptException {
            ...
            script.put("dbURL",
                    m_App.getProperties().getProperty("db.URL") + m_App.getProperties().getProperty("db.schema"));
    ...
    private void initComponents() {
        ...
        m_jPanContainer.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jPanelBag.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jButtons.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jButtonsExt.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jPanTicket.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jTicketId.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jPanTotals.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jTotalEuros.setFont(new java.awt.Font("Lucida Sans Unicode", 1, 18)); // NOI18N
        ...
        panelPrecio.setBackground(new java.awt.Color(0, 0, 0));
        panelPrecio.setPreferredSize(new java.awt.Dimension(450, 70));

        labelPrecio.setBackground(new java.awt.Color(0, 204, 51));
        labelPrecio.setFont(new java.awt.Font("Monospaced", 2, 40)); // NOI18N
        labelPrecio.setForeground(new java.awt.Color(0, 255, 51));
        ...
        panelPrecioLayout.setHorizontalGroup(
            ...
            .addComponent(labelPrecio, javax.swing.GroupLayout.DEFAULT_SIZE, 450, Short.MAX_VALUE)
        );
        ...
        m_jPanelCentral.add(panelPrecio, java.awt.BorderLayout.PAGE_START);

        m_jPanTicket.add(m_jPanelCentral, java.awt.BorderLayout.CENTER);

        m_jPanContainer.add(m_jPanTicket, java.awt.BorderLayout.CENTER);

        m_jContEntries.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jNumberKeys.setForeground(new java.awt.Color(51, 102, 255));
        ...
        m_jaddtax.setBackground(new java.awt.Color(51, 204, 255));
        ...
        btnAbrirCajon.setBackground(new java.awt.Color(255, 255, 255));
        btnAbrirCajon.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnAbrirCajon.setForeground(new java.awt.Color(51, 102, 255));
        btnAbrirCajon.setText("Abrir caja");
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(btnAbrirCajon, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        if (m_config.getProperty("lastticket.number") != null) {
            try {
                ...
                if (ticket == null) {
                    ...
                    printTicket("Printer.ReprintTicket", m_ticket, null, false);
                    Notify("'Printed'");
                }
            } catch (BasicException e) {
                MessageInf msg = new MessageInf(MessageInf.SGN_WARNING,

...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private void initComponents() {
        ...
        m_jOptions.setBackground(new java.awt.Color(255, 255, 255));
        ...
        m_jPanelTicket.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jrbSales.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jrbRefunds.setBackground(new java.awt.Color(255, 255, 255));

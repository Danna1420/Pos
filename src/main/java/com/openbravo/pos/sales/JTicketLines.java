...
public class JTicketLines extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        // Establecer el color de fondo de las celdas y el color de selecci�n
        m_jTicketTable.setBackground(Color.white);
        m_jTicketTable.setSelectionBackground(new Color(70, 130, 180));

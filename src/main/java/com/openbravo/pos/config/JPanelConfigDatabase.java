...
// secondary DB        
    ...
    private void jbtnConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnConnectActionPerformed
        try {
            ...
            if (isValid) {
                AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.databasesuccess")+
                        " Connection Test");
                ...
                AlertasPersonalizadas.mostrarAlertaInformacion("Connection Error");
            ...
            if (!rs.getString(1).equals("5.7")) {
                ...
                AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.databasefail")+
                        " Connection Test");
               
            }

        } catch (InstantiationException | IllegalAccessException | MalformedURLException | ClassNotFoundException e) {
            AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.databasedrivererror")+
                        e);
        } catch (SQLException e) {
            jLblAlert.setVisible(true);   
            jLblDBServerversion.setText("");   
            AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.databaseconnectionerror")+
                        e);         
        } catch (Exception e) {
            AlertasPersonalizadas.mostrarAlertaInformacion("Unknown exception" +
                        e);
        }
    ...
    private void jbtnCreateDBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCreateDBActionPerformed
        try {
            ...
            if (isValid) {
                ...
                jLblAlert.setVisible(false);
                jtxtDbSchema.setText("unicentaopos");
                 AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.createdefaultdb")+
                        "Create Default Database");
            } else {
                jLblAlert.setVisible(true);
                jPanel1.setVisible(false);
                 AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("Connection Error"));
            }
            ...
            jLblDBServerversion.setText("");   
             ...
             AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("Unknown exception")+
                        e);
        }

...
public class JPanelConfiguration extends JPanel implements JPanelView {
    ...
    private void saveProperties() {
        ...
        try {
            config.save();
            AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.restartchanges"));
        } catch (IOException e) {
            AlertasPersonalizadas.mostrarAlertaInformacion(AppLocal.getIntString("message.cannotsaveconfig"));
        }
    }
    ...
    public boolean deactivate() {
        ...
        if (haschanged) {
            boolean confirmacion = AlertasPersonalizadas.mostrarAlertaConfirmacion(LocalRes.getIntString(AppLocal.getIntString("message.wannasave")));
    ...
    private void jbtnRestoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnRestoreActionPerformed
        boolean confirmacion = AlertasPersonalizadas.mostrarAlertaConfirmacion(LocalRes.getIntString("message.configfactory"));
        if (confirmacion) {          
            restoreProperties();
        }

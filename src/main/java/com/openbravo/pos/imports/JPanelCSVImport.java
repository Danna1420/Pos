...
//            products = new CsvReader(CSVFileName, ',' ,Charset.forName("UTF-8"));
            ...
            if (products.getHeaderCount() < 5) {
                AlertasPersonalizadas.mostrarAlertaInformacion("Incorrect header in your source file"
                        +"Header Error");
                products.close();
                return;
            }
            ...
            products.close();
             ...
             AlertasPersonalizadas.mostrarAlertaInformacion("Unable to locate " + CSVFileName 
                        +"File not found");
        }
    }
...
//                        | "".equals(productName)
            ...
            if (badCategories.size() == 1 && badCategories.get(0) == "") {
             ...
             AlertasPersonalizadas.mostrarAlertaInformacion("Import Complete"+" Imported");
...
//        badCategories = 0;
    ...
    private void initComponents() {
        ...
        jFileChooserPanel.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jCheckInCatalogue.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jCheckSellIncTax.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jTextUpdates.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jTextNoChange.setBackground(new java.awt.Color(240, 240, 240));

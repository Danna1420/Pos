...
public class JPrincipalApp extends javax.swing.JPanel implements AppUserView {
    ...
    private CustomerInfo customerInfo;
     ...
     public static Dimension previousSize = new Dimension(930, 505);
    ...
    public JPrincipalApp(JRootApp appview, AppUser appuser) {
        ...
        m_jPanelLeft.getVerticalScrollBar().setPreferredSize(new Dimension(20, 20));

        // Cambiar el color del thumb del scroll vertical en m_jPanelLeft
        JScrollBar verticalScrollBar = m_jPanelLeft.getVerticalScrollBar();
    ...
    public class ScriptMenu {
        ...
        private ScriptMenu() {
            ...
            //taskPane.setBackground(Color.blue);
    ...
    public class ScriptGroup {
        ...
        private void addAction(Action act) {
            ...
            if (m_appuser.hasPermission((String) act.getValue(ACTION_TASKNAME))) {
    ...
    private class ExitAction extends AbstractAction {
        ...
        public ExitAction(String icon, String keytext) {
            ...
            putValue(ACTION_TASKNAME, keytext);
        }
